...
vl = s:option(Value, "MonitorTimeout", translate("MonitorTimeout"))
vl.datatype = "uinteger"

vl = s:option(Value, "LowRSSIThreshold", translate("LowRSSIThreshold"))
vl.datatype = "uinteger"

vl = s:option(Value, "HighRSSIThreshold", translate("HighRSSIThreshold"))
vl.datatype = "uinteger"
