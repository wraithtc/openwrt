...
#else
#define SMD_MESSAGE_ADDR  "/etc/messaging_server_addr"
#endif
...
#define HTTPD_PORT      (SF_FEATURE_SUPPORT_HTTPD_SSL ? HTTPD_SSL_PORT : HTTPD_DEF_PORT)
#endif
...
#define CONSOLED_NO_EXIT_ON_IDLE    0
